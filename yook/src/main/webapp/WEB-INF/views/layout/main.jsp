	...
	<main role="main">
			...
			<div class="carousel-inner" role="listbox">
				<div class="carousel-item active">
					<a href="#"><img class="d-block img-fluid"
						src="/yook/img/cow.webp" alt="First slide" style="width: 100%;"></a>
				...
				<div class="carousel-item">
					<a href="#"><img class="d-block img-fluid"
						src="/yook/img/pig.webp" alt="Second slide" style="width: 100%;"></a>
					<div class="carousel-caption d-none d-md-block">
						<h5>NOTICE</h5>
						<p>식육증가 공지사항 확인하기</p>
					</div>
				...
				<div class="carousel-item">
					<a href="#"><img class="d-block img-fluid"
						src="/yook/img/chicken.webp" alt="Third slide"
						style="width: 100%;"></a>
					<div class="carousel-caption d-none d-md-block">
						<h5>BEST</h5>
						<p>베스트 상품보러 가기</p>
		...
		<div class="album py-5 bg-light">
			...
			<div id="main-container"
				style="margin-left: 240px; margin-right: 200px;">
				<div class="row">
						...
						<tbody>
							<form id="frm" name="frm">
								<c:forEach items="${list}" var="list">
									<div><a href="#this" name="title" style="text-decoration: none;">
											...
											<div class="card mb-4" style="margin-left: 20px; border: none; color: black; background-color: whitesmoke; width: 330px;">
												<img src="/yook/img/goods_upload/${IMG[0]}" width="330"
													height="330"
													style="margin-bottom: 5%; margin-left: 1px; margin-top: 15px;">
												...
												<font class="font3" style="margin-left: 9px; margin-bottom: 15px; color: gray;">
												<fmt:formatNumber value="${list.GOODS_PRICE}" pattern="#,###"></fmt:formatNumber>원/${list.GOODS_WEIGHT } <br />
