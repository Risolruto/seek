...
<script>
	...
	var pwSearch_click = function() {
		...
		$.ajax({
			...
			data : "MEM_ID=" + $("#MEM_ID2").val() + "&MEM_EMAIL="
					+ $("#MEM_EMAIL2").val() + "&random=" + $("#random").val(),
			success : function(data) {
				if (data == true) {
	...
	<div class="container" style="width: 30%;">
			...
			<div class="form-group">
				...
				<div>
					<input type="text" class="form-control" id="MEM_NAME"
						name="MEM_NAME" placeholder="이름을 입력해주세요.">
				</div>
			</div>
			<div class="form-group">
				...
				<div>
					<input type="email" class="form-control" id="MEM_EMAIL"
						name="MEM_EMAIL" placeholder="이메일을 입력해주세요.">
				</div>
			</div>
			<div class="form-group" style="height: 160px;">
				<button id="searchBtn" type="button" onclick="idSearch_click()"
					class="btn btn-primary" style="width: 49%; float: left;">확인</button>
		...
		<div id="searchP" style="display: none;">
			...
			<div class="form-group">
				...
				<div>
					<input type="email" class="form-control" id="MEM_EMAIL2"
						name="MEM_EMAIL2" placeholder="이메일을 입력해주세요.">
				</div>
			</div>
			<div class="form-group" style="height: 160px;">
				...
				<a class="btn btn-outline-primary"
					href="${pageContext.request.contextPath}/LoginForm.do"
					style="width: 49%; float: right;">취소</a> <input type="hidden"
					path="random" id="random" value="${random}" />
			</div>
		</div>
	</div>
</body>
