...
import yook.common.dao.PageMaker;
...
public class AgoodsController {
	...
	public ModelAndView openAdminGoodsList(CommandMap commandMap, Pagination pagi)throws Exception{
		ModelAndView mv = new ModelAndView("adminGoodsList");
		List<Map<String, Object>> list = agoodsService.agoodsList(pagi);
		//(commandMap.getMap());
		mv.addObject("list", list);
		
		PageMaker pageMaker = new PageMaker();
		pageMaker.setPage(pagi);
		pageMaker.setTotalCount(agoodsService.listCount());
